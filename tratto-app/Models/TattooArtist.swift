...
//    var portfolioImages: [String] // Nomes das imagens
    ...
    init(name: String, age: Int, bio: String, profilePicture: String, address: String, phoneNumber: String, instagramURL: String, experienceYears: Int, isFavorite: Bool = false) {
        self.name = name
        self.age = age
        self.bio = bio
